            ...
            <div class="d-flex justify-content-center freshman-content-position">
                <div class="text-center freshman-content">
                    ...
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-a" class="custom-control-input custom-checkbox-point" name="kyushu">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-a">九州学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-b" class="custom-control-input custom-checkbox-point" name="cognitive_psychology">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-b">認知心理学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-c" class="custom-control-input custom-checkbox-point" name="literature">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-c">文学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-d" class="custom-control-input custom-checkbox-point" name="overseas_circumstances">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-d">海外事情</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-e" class="custom-control-input custom-checkbox-point" name="japan_circumstances-one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-e">日本事情Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-f" class="custom-control-input custom-checkbox-point" name="communication_basics">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-f">コミュニケーション基礎</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-g" class="custom-control-input custom-checkbox-point" name="economy_and_society">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-g">経済と社会</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-h" class="custom-control-input custom-checkbox-point" name="ethics">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-h">倫理学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-i" class="custom-control-input custom-checkbox-point" name="life_and_law">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-i">日常生活と法</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-j" class="custom-control-input custom-checkbox-point" name="japan_circumstances-two">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-j">日本事情Ⅱ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-k" class="custom-control-input custom-checkbox-point" name="nature_and_science">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-k">自然と科学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-l" class="custom-control-input custom-checkbox-point" name="earth_and_environment">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="lae-cb-l">地球と環境</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="lae-cb-m" class="custom-control-input custom-checkbox-point" name="health_kinesiology">
                ...
                <div class="text-center freshman-content">
                    ...
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-a" class="custom-control-input custom-checkbox-point" name="advanced_english_a">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-a">Advanced English A</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-b" class="custom-control-input custom-checkbox-point" name="english_a">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-b">English A</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-c" class="custom-control-input custom-checkbox-point" name="chinese_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-c">中国語Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-d" class="custom-control-input custom-checkbox-point" name="korean_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-d">韓国語Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-e" class="custom-control-input custom-checkbox-point" name="Japanese_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-e">日本語Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-f" class="custom-control-input custom-checkbox-point" name="career_development">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-f">キャリア形成</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-g" class="custom-control-input custom-checkbox-point" name="japanese_expression">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-g">日本語表現</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-h" class="custom-control-input custom-checkbox-point" name="advanced_english_b">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-h">Advanced English B</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-i" class="custom-control-input custom-checkbox-point" name="english_b">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-i">English B</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-j" class="custom-control-input custom-checkbox-point" name="chinese_two">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-j">中国語Ⅱ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-k" class="custom-control-input custom-checkbox-point" name="korean_two">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="st-cb-k">韓国語Ⅱ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="st-cb-l" class="custom-control-input custom-checkbox-point" name="Japanese_two">
                ...
                <div class="text-center freshman-content">
                    ...
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-a" class="custom-control-input custom-checkbox-point" name="basic_physics">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="sf-cb-a">基礎物理学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-b" class="custom-control-input custom-checkbox-point" name="basic_electromagnetism">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="sf-cb-b">基礎電磁気学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-c" class="custom-control-input custom-checkbox-point" name="linear_algebra_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="sf-cb-c">線形代数Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-d" class="custom-control-input custom-checkbox-point" name="analysis_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="sf-cb-d">解析Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-e" class="custom-control-input custom-checkbox-point" name="physics_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="sf-cb-e">物理学Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-f" class="custom-control-input custom-checkbox-point" name="linear_algebra_two">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="sf-cb-f">線形代数Ⅱ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="sf-cb-g" class="custom-control-input custom-checkbox-point" name="analysis_two">
                ...
                <div class="text-center freshman-content">
                    ...
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-a" class="custom-control-input custom-checkbox-point" name="basic_information_seminar">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-a">情報基礎ゼミナール</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-b" class="custom-control-input custom-checkbox-point" name="computer_science">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-b">コンピュータ科学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-c" class="custom-control-input custom-checkbox-point" name="computer_literacy">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-c">コンピュータリテラシー</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-d" class="custom-control-input custom-checkbox-point" name="c_programming_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-d">CプログラミングⅠ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-e" class="custom-control-input custom-checkbox-point" name="electric_circuit_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-e">電気回路Ⅰ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-f" class="custom-control-input custom-checkbox-point" name="discrete_mathematics">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-f">離散数学</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-g" class="custom-control-input custom-checkbox-point" name="c_programming_two">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-g">CプログラミングⅡ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-h" class="custom-control-input custom-checkbox-point" name="electric_circuit_two">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-h">電気回路Ⅱ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-i" class="custom-control-input custom-checkbox-point" name="computer_architecture_one">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-i">コンピュータアーキテクチャⅠ</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-j" class="custom-control-input custom-checkbox-point" name="fundamentals_of_artificial_intelligence">
                        <label class="custom-control-label u-font-size-90 custom-checkbox-point" for="se-cb-j">人工知能基礎</label>
                    </div>
                    <div class="custom-control custom-checkbox text-left ml-3 mb-5">
                        <input type="checkbox" id="se-cb-k" class="custom-control-input custom-checkbox-point" name="multimedia_engineering">
